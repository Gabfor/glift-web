      ...
      >
        ...
        <div className="flex justify-center gap-4 mb-4 flex-wrap">
          <Link
            ...
            className="bg-[var(--color-brand-primary)] hover:bg-[var(--color-brand-primary-hover)] text-white text-[16px] font-semibold px-5 h-[44px] rounded-full flex items-center justify-center gap-2 transition"
          >
            Tester gratuitement
            <Image
              src="/icons/arrow.svg"
          ...
          <Link
            href="#methode-glift"
            className="border-2 border-[var(--color-brand-strong)] text-[var(--color-brand-strong)] hover:text-white hover:bg-[var(--color-brand-strong)] text-[16px] font-semibold px-5 h-[44px] rounded-full flex items-center gap-2 transition"
          >
            En savoir plus
          </Link>
        </div>
...
<div className="absolute left-[120px] top-[40%] -translate-y-1/2 hidden md:block">
  ...
  />
      ...
      <section className={`${surfaceBackground} ${maxContentWidth} mx-auto px-4 py-[30px] flex flex-col md:flex-row items-center justify-between gap-10`}>
        ...
        <div className="max-w-[520px] flex flex-col">
          ...
          <Link
            href="/inscription?plan=premium"
            className="w-[204px] h-[44px] group border-2 border-[var(--color-brand-strong)] text-[var(--color-brand-strong)] hover:text-white hover:bg-[var(--color-brand-strong)] font-semibold rounded-full flex items-center justify-center gap-1 transition"
          >
            Tester gratuitement
  ...
  <div className="bg-white rounded-[12px] p-6 flex flex-col gap-4 shadow-glift hover:shadow-glift-hover transition-shadow duration-300">
    ...
    <div className="h-[44px] w-[237px] group border-2 border-[var(--color-brand-strong)] text-[var(--color-brand-strong)] hover:text-white hover:bg-[var(--color-brand-strong)] font-semibold rounded-full flex items-center justify-center gap-1 transition cursor-pointer">
  ...
  <div className="bg-white rounded-[12px] p-6 flex flex-col gap-4 shadow-glift hover:shadow-glift-hover transition-shadow duration-300">
    ...
    <div className="h-[44px] w-[235px] group border-2 border-[var(--color-brand-strong)] text-[var(--color-brand-strong)] hover:text-white hover:bg-[var(--color-brand-strong)] font-semibold rounded-full flex items-center justify-center gap-1 transition cursor-pointer">
