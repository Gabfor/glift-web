    ...
    >
      ...
      <button
        ...
        className={`
          ...
          focus:outline-none
          ${open ? "border-transparent ring-2 ring-[#A1A5FD]" : (success ? "border-[#00D591] hover:border-[#00D591] focus:border-transparent focus:ring-2 focus:ring-[#A1A5FD]" : defaultBorder)}
          ${buttonClassName}
        `}
      >
        <span
