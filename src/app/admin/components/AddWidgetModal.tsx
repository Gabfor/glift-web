...
export default function AddWidgetModal({ articleType, onClose, onSelect }: AddWidgetModalProps) {
  ...
  return (
    <Modal
      ...
      onClose={onClose}
      contentClassName={isPage ? "w-[880px] max-w-[95vw] !p-[40px]" : "w-[680px] max-w-[95vw] !p-[40px]"}
    >
      <div className={`grid ${isPage ? "grid-cols-4" : "grid-cols-3"} gap-5 mt-8`}>
            ...
            {articleType === "Legal" ? (
              ...
              <>
                ...
                >
                  ...
                  <div className="w-[85%]">
                    <div className="w-full h-[20px] bg-[#F4F5FE] rounded-[4px]" />
                  </div>
                </button>
