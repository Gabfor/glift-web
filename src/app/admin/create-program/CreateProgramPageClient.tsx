...
export default function CreateProgramPageClient({
  ...
  const textareaClass =
    "min-h-[143px] w-full text-[16px] font-semibold placeholder-[#D7D4DC] px-[15px] py-[10px] rounded-[5px] bg-white text-[#5D6494] border border-[#D7D4DC] hover:border-[#C2BFC6] focus:border-transparent focus:outline-none focus:ring-2 focus:ring-[#5D6494] transition-all duration-150";
    ...
    <>
      ...
      <main className="min-h-screen bg-transparent px-4 pt-[100px] md:pt-[140px] pb-[100px]">
        <div className="max-w-[1152px] mx-auto w-full relative z-10">
          <BackLink href="/admin/program-store" className="mb-6">
            Store
          </BackLink>
