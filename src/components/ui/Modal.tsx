  ...
  return createPortal(
    ...
    >
      ...
      <div
        ...
        className={clsx(
          "relative z-10 w-[564px] max-w-[92vw] max-h-[90vh] overflow-y-auto rounded-[20px] bg-white p-5 sm:p-8 shadow-glift-hover animate-in fade-in zoom-in-95 duration-300",
          contentClassName
        )}
      >
        {showCloseButton && (
