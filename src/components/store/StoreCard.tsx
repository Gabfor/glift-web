    ...
    <div className="w-full max-w-[270px] bg-white rounded-[5px] border border-[#ECE9F1] overflow-hidden flex flex-col shadow-glift hover:shadow-glift-hover transition-all duration-300 transform hover:-translate-y-1">
      ...
      <div className="pt-2 px-2.5 pb-5 flex-1 flex flex-col">
        ...
        <button
          ...
          className={`
            w-auto px-6 h-[44px]
            bg-[#7069FA] text-white rounded-full font-bold text-[16px]
            transition flex items-center justify-center gap-2 mx-auto
            ${loading ? 'opacity-100 cursor-wait' : 'hover:bg-[#5E57D8] cursor-pointer'}
            disabled:!bg-[#7069FA] disabled:!text-white disabled:opacity-100 disabled:!cursor-wait disabled:hover:!bg-[#7069FA]
          `}
        >
          <div className="flex items-center justify-center h-[20px] gap-2">
            {loading ? (
              <>
                <Spinner size="md" className="text-white" ariaLabel="Téléchargement en cours" />
                En cours...
              </>
            ) : (
              <>
          ...
          <button
            ...
            className="w-auto px-6 h-[44px] bg-[#F2F1F6] hover:bg-[#ECE9F1] text-[#D7D4DC] hover:text-[#C2BFC6] rounded-full font-bold text-[16px] flex items-center justify-center gap-2 mx-auto"
          >
            <Image
