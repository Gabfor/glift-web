...
export default function EmailInfoAdornment({
  ...
  const GAP = 12    // ← 5px à droite de l'icône
  ...
  useEffect(() => {
    ...
    // Fermeture immédiate si la souris n'est plus sur l'icône NI sur la bulle
  ...
  return (
    <>
      {/* Icône (ancre) – le TextField place ce bloc à 10px à droite du champ */}
      <span
        ref={anchorRef}
      ...
      {/* Tooltip via PORTAL (jamais rogné) */}
