...
export default function Footer() {
  return (
    <footer className="mb-[3px] max-w-[1152px] mx-auto bg-[#FBFCFE] text-[#5D6494] text-sm font-medium border-t border-[#ECE9F1] pt-[0px] pb-[30px]">
      {/* Top Section */}
      <div className="mt-[20px] max-w-[1152px] mx-auto flex flex-col lg:flex-row justify-between items-center gap-10 border-b border-[#ECE9F1] pb-10 pb-[30px]">
      ...
      <div className="max-w-[1152px] mx-auto mt-[30px] grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-8 text-white">
        ...
        <Link href="#">GLIFT</Link>
          ...
          <ul className="text-[#5D6494] font-semibold space-y-1">
            <li><Link href="#" className="hover:text-[#3A416F] transition-colors">Glift Store</Link></li>
            <li><Link href="#" className="hover:text-[#3A416F] transition-colors">Glift Shop</Link></li>
            <li><Link href="#" className="hover:text-[#3A416F] transition-colors">Tarifs</Link></li>
          </ul>
        </div>
        <div>
          <h4 className="text-[#3A416F] font-bold mb-2">
