...
export default function ShopGridSkeleton() {
  return (
    <div className="flex flex-col gap-5 md:grid md:gap-6 md:grid-cols-[repeat(auto-fill,minmax(270px,1fr))] justify-center mt-8">
      {skeletonItems.map((_, index) => (
        <div
          key={index}
          className="relative w-full bg-white rounded-[15px] border border-[#D7D4DC] overflow-hidden flex flex-col shadow-[0_4px_20px_rgba(93,100,148,0.06)] animate-pulse"
        >
